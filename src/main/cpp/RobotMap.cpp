...
const double WheelDiameter = 0.1455;      // wheel diameter in meters (6")
...
const double BallIntakeUpPos = 0.06;
...
// Up
const double BallIntake_kpUp = 0.03;
...
const double BallIntake_minOutUp = -0.1;
const double BallIntake_maxOutUp = 0.4;
...
const double BallIntake_allowedErrorDown = 0.01;
...
//Lock arm
const double BallIntake_kpLock = 1.3;
...
const double BallIntake_minOutLock = 0.03;
